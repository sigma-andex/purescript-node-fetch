...
import Node.Fetch.Headers as Headers
import Node.Fetch.Integrity (Integrity(..))
import Node.Fetch.Referrer (Referrer)
import Node.Fetch.Referrer as Referrer
import Node.Fetch.ReferrerPolicy (ReferrerPolicy)
import Node.Fetch.ReferrerPolicy as ReferrerPolicy
import Node.Fetch.RequestBody (RequestBody)
import Node.Fetch.RequestBody as RequestBody
import Node.Fetch.RequestCache (RequestCache)
import Node.Fetch.RequestCache as RequestCache
import Node.Fetch.RequestCredentials (RequestCredentials)
import Node.Fetch.RequestCredentials as RequestCredentials
import Node.Fetch.RequestMode (RequestMode)
import Node.Fetch.RequestMode as RequestMode
...
toUnsafeOptions opts =
  ...
  -- On node this may not be null, however web-fetch specifies it as Nullable
  -- Keeping it Nullable therefore
  , referrer: Nullable.notNull $ fromMaybe "" $ Referrer.toString <$> opts.referrer
